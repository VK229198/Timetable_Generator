...
#------------------------------------------------------------------------------
# TO CREATE EMPTY TIMETABLE WITH DESIGNATED AMOUNT OF DAYS (IN OUR CASE IT'S 5)
#------------------------------------------------------------------------------
...
#-------------------------------------------------------
# TO GET THE FACULTIES THAT TEACH ONE PARTICULAR SECTION
#-------------------------------------------------------
...
#--------------------------------------------------------------
# TO CHECK WHETHER A PARTICULAR TEACHER IS FREE AT A GIVEN TIME
#--------------------------------------------------------------
...
def fill_timetable_correctly(timetable):
    #----------------------------------------
    # CHECKING FOR MINORS AND ELECTIVES
    #--------------------------------------
    for section in SECTIONS:
        ...
        #-------------------------------------------------------------------------
        # SETTING LAB HOURS (THEY MUST BE CONTINOUS AND IDEALL BEFORE LUNCH BREAK)
        #-------------------------------------------------------------------------
        for lab in LAB_COURSES:
            ...
            while lab_hours > 0 and attempts < 200:
                ...
                possible_starts = list(range(0, 3) if attempts < 100 else range(PERIODS_PER_DAY - 1))
...
#=====================================
# HOPEFULLY WE DON'T NEED THIS PART
#====================================
            if hours_needed > 0:
